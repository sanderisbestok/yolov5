:warning: **This is not ther original YoloV5**: This version is edited so it can be used for my Thesis. For the official ExtremNet repo please go to [this repository](https://github.com/sanderisbestok/yolov5).
